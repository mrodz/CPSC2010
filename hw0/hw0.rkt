...
(define (kg2lb mass)
  (define ounces (exact-floor (* (* mass 2.2) 16.0)))
  (define ounces_part (modulo ounces 16))
  (define pounds_part (/ (- ounces ounces_part) 16))
  (define ounces_desc (if (= ounces_part 1) 'ounce 'ounces))
  (define pounds_desc (if (= pounds_part 1) 'pound 'pounds))
  (list pounds_part pounds_desc ounces_part ounces_desc))
